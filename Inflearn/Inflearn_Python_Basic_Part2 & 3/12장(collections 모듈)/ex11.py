...
# most_common(n) : 입력된 값 요소들 중 빈도수가 높은 순으로
# 상위 n개를 리스트 안에 튜플형태로 반환하는 메서드
print("-"*50)
count = Counter("apple, orange, grape")
# 매개변수를 주지않았을 때는 전체 문자열을 대상으로 값과 빈도수를 출력
print(count.most_common())
# 매개변수를 주엇을때 전체 문자열 대상으로 빈도수를 순서가 높은순으로
# n개만큼 출력을 해준다.
print(count.most_common(5)) 


# substract() : 단어 그대로 요소의 값을 빼는 것을 의미함
# 요소가 없는 경우 음수 값 출력
print("-"*50)
...
print("-"*50)
# 연산자로 뺄셈을 하면 음수의 값을 출력하지 아니한다.(substract와 차이점)
c1 = Counter(["a","b","c","d","a"])
c2 = Counter("apple")
print(c1)
print(c2)
